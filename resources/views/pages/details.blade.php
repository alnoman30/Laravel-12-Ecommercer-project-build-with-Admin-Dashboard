  ...
  <section class="product-single container">
    <div class="row">
            ...
            <div class="swiper-container">
              <div class="swiper-wrapper">
                <div class="swiper-slide product-single__image-item">
                  <img loading="lazy" class="h-auto" src="{{ asset('uploads/products')}}/{{ $products->image}}" width="674"
                    height="674" alt="" />
                  <a data-fancybox="gallery" href="{{ asset('uploads/products')}}/{{ $products->image}}" data-bs-toggle="tooltip"
                ...
                @foreach ( json_decode($products->gallery_images) as $galleryImage )
                <div class="swiper-slide product-single__image-item">
                  <img loading="lazy" class="h-auto" src="{{ asset($galleryImage)}}" width="674"
                    height="674" alt="" />
                  <a data-fancybox="gallery" href="{{ asset($galleryImage)}}" data-bs-toggle="tooltip"
                    data-bs-placement="left" title="Zoom">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <use href="#icon_zoom" />
                    </svg>
            ...
            <div class="swiper-container">
              <div class="swiper-wrapper">
                <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                    src="{{ asset('uploads/products')}}/{{$products->image}}" width="104" height="104" alt="" />
                  </div>

                  @foreach (json_decode($products->gallery_images) as $galleryImage )
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                    src="{{ asset($galleryImage)}}" width="104" height="104" alt="" />
                  </div>
                  @endforeach
              </div>
            </div>
      ...
      <div class="col-lg-5">
        ...
        <h1 class="product-single__name">{{ $products->name }}</h1>
        ...
        <div class="product-single__price">
          ...
          <span class="money price price-old">${{ $products->regular_price}}</span>
          <span class="money price price-sale">${{ $products->sale_price}}</span>
          @else
          <span class="money price price-old">${{ $products->regular_price}}</span>
          @endif
        </div>
  ...
  <section class="products-carousel container">
    ...
    <div id="related_products" class="position-relative">
      <div class="swiper-container js-swiper-slider" data-settings='{
        ...
        <div class="swiper-wrapper">
          @foreach ( $relatedProducts as $r_prod )
          <div class="swiper-slide product-card">
            ...
            <div class="pc__info position-relative">
              <p class="pc__category">{{ $r_prod->category->category_name}}</p>
              <h6 class="pc__title"><a href="details.html">{{ $r_prod->name}}</a></h6>
