          ...
          <div id="accordion-filter-1" class="accordion-collapse collapse show border-0"
            ...
            <div class="accordion-body px-0 pb-0 pt-3">
              <ul class="list list-inline mb-0">
                ...
                <li class="list-item">
                  <a href="#" class="menu-link py-1">{{ $category->category_name}}</a>
                </li>
                @endforeach
              </ul>
            </div>
          ...
          <div class="product-card mb-3 mb-md-4 mb-xxl-5">
            <div class="pc__img-wrapper">
              <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <a href="{{ route('products_details', $product->slug) }}"><img loading="lazy" src="{{ asset('uploads/products')}}/{{ $product->image }}" width="330"
                        height="400" alt="{{ $product->name }}" class="pc__img"></a>
                  </div>
                  @foreach ( json_decode($product->gallery_images) as $galleryImage )
                  <div class="swiper-slide">
                    <a href="{{ route('products_details', $product->slug) }}"><img loading="lazy" src="{{ asset($galleryImage)}}"
            ...
            <div class="pc__info position-relative">
              ...
              <h6 class="pc__title"><a href="{{ route('products_details', $product->slug) }}">{{ $product->name }}</a></h6>
