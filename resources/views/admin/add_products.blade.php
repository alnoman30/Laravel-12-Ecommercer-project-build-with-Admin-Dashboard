    ...
    <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.store_products') }}">
        ...
        <div class="wg-box">
            <fieldset class="name">
                ...
                <input class="mb-10" type="text" name="name" value="{{ old('name') }}" placeholder="Enter product name" required>
            </fieldset>

            <fieldset class="name">
                <div class="body-title mb-10">Slug <span class="tf-color-1">*</span></div>
                <input class="mb-10" type="text" name="slug" value="{{ old('slug') }}" placeholder="Enter product slug" required>
            </fieldset>
        ...
        <div class="wg-box">
            ...
            <div class="cols gap22">
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="number" step="0.01" name="regular_price" value="{{ old('regular_price') }}" required>
                </fieldset>
                <fieldset class="name">
                    <div class="body-title mb-10">Sale Price</div>
                    <input class="mb-10" type="number" step="0.01" name="sale_price" value="{{ old('sale_price') }}">
                </fieldset>
            </div>
            ...
            <div class="cols gap22">
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" name="sku" value="{{ old('sku') }}" >
                </fieldset>
                <fieldset class="name">
                    <div class="body-title mb-10">Quantity <span class="tf-color-1">*</span></div>
                    <input class="mb-10" type="number" name="quantity" min="0" value="{{ old('quantity', 10) }}" required>
                </fieldset>
            </div>
