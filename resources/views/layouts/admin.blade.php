                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.add_products')}}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.add_brands')}}" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.add_categories')}}" class="">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('admin.user_list')}}" class="">
                ...
                <div class="section-content-right">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <form action="{{ route('logout') }}" method="POST" id="logout-form">
                                                    @csrf
                                                    <a href="#" class="user-item" onclick="document.getElementById('logout-form').submit();" style="text-decoration: none;">
                                                        <div class="icon">
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2025 Ultras.</div>
                        </div>
                    </div>
